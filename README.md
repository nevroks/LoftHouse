...
Тут присутвуют анимации написанные через js(там где нужно) и css,довольно хороший сайт но в макете небыло других страниц так чсто написаны просто заглушки, использована библеотка <strong>YoutubeLightBox<strong/>.<br/>
